...
export function HotelPolicyFields({ hotel }: { hotel?: Partial<Hotel> }) {
    return (
        <section className="space-y-6 rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-950/40 p-5">
            <div>
                <h3 className="text-lg font-semibold text-zinc-900 dark:text-white">Guest Policy</h3>
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div className="space-y-2">
                    <Label htmlFor="free_cancellation_window_hours" className="text-zinc-700 dark:text-zinc-300">
                ...
                <div className="space-y-2">
                    <Label htmlFor="partial_cancellation_window_hours" className="text-zinc-700 dark:text-zinc-300">
                ...
                <div className="space-y-2">
                    <Label htmlFor="partial_cancellation_penalty_percent" className="text-zinc-700 dark:text-zinc-300">
                        Standard Penalty
                    </Label>
                    <Input
                ...
                <div className="space-y-2">
                    <Label htmlFor="late_cancellation_penalty_percent" className="text-zinc-700 dark:text-zinc-300">
                ...
                <div className="space-y-2 md:col-span-2">
                    <Label htmlFor="modification_cutoff_hours" className="text-zinc-700 dark:text-zinc-300">
                ...
                <div className="space-y-2 md:col-span-2">
                    <Label htmlFor="cancellation_policy_notes" className="text-zinc-700 dark:text-zinc-300">
                        Policy Notes
                    </Label>
                    <Textarea
                        ...
                        className="min-h-[96px] border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-zinc-900 dark:text-white"
                    />
                </div>
            </div>
        </section>
